...
class WhiteSpacePreprocessingStopwords():
    ...
    def __init__(self, documents, stopwords_list=None, vocabulary_size=2000, max_df=1.0,
                 min_df=1, min_words=1, remove_numbers=True):
        """
    ...
    def split_text(self, text): 
        """
        takes a string of pre-tokenized text and splits into tokens
        text: string of text 
        """
        return text.split() 
